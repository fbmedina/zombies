...
class Person < Creature
  ...
  def danger(zombie)
    ...
    if @position_x.between?(zombie.position_x - 3, zombie.position_x + 3) && @position_y.between?(zombie.position_y - 3, zombie.position_y + 3)
  ...
  def dying(zombie)
    ...
    if @position_x.between?(zombie.position_x - 1, zombie.position_x + 1) && @position_y.between?(zombie.position_y - 1, zombie.position_y + 1)
